...
const testSchedule = [
  { startTime: new Time(9, 0), endTime: new Time(12, 0), location: 'water cooler' },
  { startTime: new Time(12, 0), endTime: new Time(17, 0), location: 'cafeteria' },
];
...
describe('Person', () => {
  ...
  describe('messaging', () => {
    ...
    it('receiveToken delegates to brain and passes action to done', () => {
      ...
      let receivedAction;
      alice.receiveToken([bob], 'cafeteria', (action) => { receivedAction = action; });
