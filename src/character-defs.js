...
const alice = {
  ...
  schedule: [
    ...
    { startTime: new Time(13, 0), endTime: new Time(14, 30), location: "cubicle" },
    { startTime: new Time(14, 30), endTime: new Time(15, 30), location: "water cooler" },
    { startTime: new Time(15, 30), endTime: new Time(17, 0), location: "cubicle" },
  ],
  character: {
